...
Config an environment variable with the next configuration:

```
GOOGLE_APPLICATION_CREDENTIALS=C:\t-kingdom-347716-ff4f18d1363d.json
```

File t-kingdom-347716-ff4f18d1363d.json is ubicated in src/main/resouces path inside de project

## Building for production

### Packaging as jar

To build the final jar and optimize the testgatling application for production, run:
